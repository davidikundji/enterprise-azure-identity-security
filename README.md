...
- Enforced Zero Trust security principles  

---

### 🔹 Lab 3 – Microsoft Sentinel (SIEM)
- Deployed Microsoft Sentinel  
- Monitored login activity and security events  
...
- Integrated on-prem Active Directory with Azure AD  
...
- Designed secure Azure VNet architecture  
...
- Assessed security posture using Secure Score  
- Remediated security recommendations  
...
- Built a complete **cloud identity and security environment from scratch**  
- Implemented **end-to-end IAM and Zero Trust controls**  
- Automated identity processes using PowerShell  
- Integrated hybrid identity between on-prem and cloud  
- Designed secure network architecture in Azure  
...
> *(Add screenshots here for extra impact — highly recommended)*

---

## 🎯 Why This Project Matters

This project demonstrates practical, hands-on experience with tools and technologies used in real enterprise environments. It highlights the ability to:
...
This project reflects my hands-on experience and continuous learning in cloud security and identity management. I am actively seeking opportunities in:
